...
int main() {
    ...
    fprintf(stderr, "sequential insertion.... OK\n");
    ...
    fprintf(stderr, "randim insertion.... OK\n");
    ...
    fprintf(stderr, "random deletion.... OK\n");
    ...
    fprintf(stderr, "insertion/deletion at varios pos.... OK\n");
